...
const RegistrationPage1 = () => {
  ...
  // Psychologist Additional Form Data
  ...
  const validatePsychInfo = () => {
    const newErrors = {};
    if (accountType === "psychologist") {
      if (!psychFormData.education) {
        newErrors.education = "Education qualification is required";
      }
      if (!psychFormData.licenseNumber) {
        newErrors.licenseNumber = "License number is required";
      }
      if (!psychFormData.specialization) {
        newErrors.specialization = "Specialization is required";
      }
      if (!psychFormData.agreementChecked) {
  ...
  const handleSubmit = async (e) => {
    ...
    switch (accountType) {
      ...
      case "parent":
        ...
        break;
      case "psychologist":
        isValid = validateBasicInfo() && validatePsychInfo();
        break;
    }
    ...
    if (isValid) {
      ...
      try {
        ...
        const submitData = {
          ...
          ...(accountType === "psychologist" && { professionalInfo: psychFormData }),
        };
  ...
  const renderAccountTypeSelection = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {["student", "parent", "psychologist"].map((type) => (
          <button
            key={type}
            type="button"
          ...
          >
            ...
            <div className="text-sm text-gray-500 mt-1">
              ...
              {type === "psychologist" && "Register as a mental health professional"}
            </div>
          </button>
        ))}
      </div>
  ...
  const renderPsychologistForm = () => {
    if (step === 3) {
      return (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-center mb-6">Professional Information</h3>
          
          <select
            value={psychFormData.education}
            onChange={(e) =>
              setPsychFormData({ ...psychFormData, education: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-200 outline-none"
          >
            <option value="">Select Education Level</option>
            <option value="bachelors">Bachelor's in Psychology</option>
            <option value="masters">Master's in Psychology</option>
            <option value="doctorate">Doctorate in Psychology</option>
          </select>

          <select
            value={psychFormData.specialization}
            onChange={(e) =>
              setPsychFormData({ ...psychFormData, specialization: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-200 outline-none"
          >
          ...
          <input
            ...
            value={psychFormData.licenseNumber}
            onChange={(e) =>
              setPsychFormData({ ...psychFormData, licenseNumber: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-200 outline-none"
          />
          ...
          <input
            ...
            value={psychFormData.experience}
            onChange={(e) =>
              setPsychFormData({ ...psychFormData, experience: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-200 outline-none"
          />
          ...
          <input
            ...
            value={psychFormData.currentEmployment}
            onChange={(e) =>
              setPsychFormData({ ...psychFormData, currentEmployment: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-200 outline-none"
          />
      ...
      return (
        <div className="space-y-6">
          ...
          <input
            ...
            value={psychFormData.username}
            onChange={(e) =>
              setPsychFormData({ ...psychFormData, username: e.target.value })
            }
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-200 outline-none"
          />
          ...
          <div className="space-y-4">
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
                checked={psychFormData.agreementChecked}
                onChange={(e) =>
                  setPsychFormData({
                    ...psychFormData,
            ...
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
                checked={psychFormData.verificationChecked}
                onChange={(e) =>
                  setPsychFormData({
                    ...psychFormData,
  ...
  const isLastStep = () => {
    ...
    if (accountType === "psychologist") return step === 4;
    return false;
  };
      ...
      <div className="lg:w-1/2 ml-auto min-h-screen overflow-y-auto flex flex-col items-center p-8 bg-white">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="flex justify-center items-center space-x-4 mb-8">
            {[1, 2, 3, accountType === "psychologist" ? 4 : null]
              .filter(Boolean)
              .map((stepNumber) => (
                <div
                  key={stepNumber}
