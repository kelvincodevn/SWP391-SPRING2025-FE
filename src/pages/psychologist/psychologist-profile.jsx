...
import { FaUser, FaEnvelope, FaGraduationCap, FaBriefcase } from 'react-icons/fa'; // Importing icons

function PsychologistProfile() {
  // Define state for the psychologist data
  ...
  // Fetch psychologist profile from API
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        toast.error('Failed to fetch psychologist profile');
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const psychologistId = localStorage.getItem('psychologistId');
      const updatedData = await updatePsychologistProfile(psychologistId, psychologistData);
