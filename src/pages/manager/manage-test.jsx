...
function ManageTest() {
    ...
    const [questions, setQuestions] = useState([]); // State for questions and answers
                ...
                <ul>
                    {testDetails.questions.map((question) => (
                        <li key={question.questionNumber}>
                            <strong>Q{question.questionNumber}:</strong> {question.questionText}
                            <ul>
                                {question.answers.map((answer) => (
                                    <li key={answer.answerText}>
                                        {answer.answerText} (Score: {answer.score})
                                    </li>
                                ))}
                            </ul>
                        </li>
